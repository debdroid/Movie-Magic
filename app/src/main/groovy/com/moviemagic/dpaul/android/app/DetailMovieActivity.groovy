...
@CompileStatic
class DetailMovieActivity extends AppCompatActivity implements DetailMovieFragment.BackdropCallback,
        DetailMovieFragment.MovieTitleAndColorCallback, DetailMovieFragment.UserListButtonClickCallback {
...
//                movieDetailFragment.setArguments(args)
                ...
                fragmentTransaction.replace(R.id.movie_detail_container, movieDetailFragment).commit()
            } else {
...
//                    LogDisplay.callLog(LOG_TAG, "evenOrOdd value:$evenOrOdd", LogDisplay.DETAIL_MOVIE_ACTIVITY_LOG_FLAG)
    ...
    @Override
    void onBackPressed() {
        LogDisplay.callLog(LOG_TAG, 'onBackPressed is called', LogDisplay.DETAIL_MOVIE_ACTIVITY_LOG_FLAG)
        super.onBackPressed()
    ...
    void finishCurrentActivity() {
        LogDisplay.callLog(LOG_TAG, 'finishCurrentActivity is called', LogDisplay.DETAIL_MOVIE_ACTIVITY_LOG_FLAG)
        finish()
    }
}